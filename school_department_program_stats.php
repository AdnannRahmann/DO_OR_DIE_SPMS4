        ...
        <div class="row">
            ...
            <div class="logo">
                ...
                <div class="left-navigation">
                    ...
                    <br>
                    <h4 class="list-header"><strong>GPA Analysis</strong></h4>
...
<div class="row">
  <div class="col"><button onclick="schoolWiseGpa()"  class="School-wise">School-wise GPA Trend</button></div>
  <div class="col"><button onclick="departmentWiseGpa()"  class="Department-wise">Department-wise GPA Trend</button></div>
  <div class="col"><button onclick="programWiseGpa()"  class="Program-wise">Program-wise GPA Trend</button></div>
</div>

<div class="row3" style="margin-top:20px;"> 
 <div id="Spring" style="width: 350px; height: 350px; display:inline-block;"></div>
 <div id="Summer" style="width: 350px; height: 350px; display:inline-block;"></div>
 <div id="Autumn" style="width: 350px; height: 350px; display:inline-block;"></div>

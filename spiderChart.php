...
<!-- div row-1 starts here -->
    ...
    <div style="display:flex;justify-content:center;margin-bottom:10px;">
        ...
        <div style="display:flex;justify-content:center;margin-top:5px;height:500px;width:100%;"class="row3"> 
        <canvas style="background-color:white;height:400px;width:400px;" id="myChart"></canvas>

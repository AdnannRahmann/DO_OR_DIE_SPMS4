        ...
        <div class="row">
            ...
            <div class="logo">
                ...
                <div class="left-navigation">
                    ...
                    <br>
                    <h4 class="list-header"><strong>GPA Analysis (Instructor-wise)</strong></h4>
...
<button onclick="viewInstructorWiseChosenCourse()" style="height: 46px;width: 100px;margin-left:50px;display:inline-block; border-radius: 10px; border: none;outline: none;background:#F58D63;color: #fff;font-size: 14px;letter-spacing:2px;text-transform: uppercase;cursor:pointer;font-weight: bold;">
  view</button>
</div>

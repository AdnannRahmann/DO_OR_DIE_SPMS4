        ...
        <div class="row">
            ...
            <div class="logo">
                ...
                <div class="left-navigation">
                    ...
                    <br>
                    <h4 class="list-header"><strong>GPA Analysis (Course-wise)</strong></h4>
...
style="height:50px;display:flex;justify-content:space-around;">
  ...
  style="margin-left:99px;width:250px;height:100%;margin-top:0px;">
...
<button onclick="viewInstructorWise()" style="height: 46px;width: 100px;margin-left:110px;display:inline-block; border-radius: 10px; border: none;outline: none;background:#f1ab53;color: #fff;font-size: 14px;letter-spacing:2px;text-transform: uppercase;cursor:pointer;font-weight: bold;">
  view</button>
</div>

<div class="row3" style="margin-top:5px;"> 
 <div id="Spring" style="width: 430px; height: 430px; display:inline-block;"></div>
 <div id="Summer" style="width: 430px; height: 430px; display:inline-block;"></div>
 <div id="Autumn" style="width: 430px; height: 430px; display:inline-block;"></div>
</div>
</div>  

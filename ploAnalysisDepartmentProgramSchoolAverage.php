...
<form method="POST">
  <input style="background-color:#F58D63;height:50px;border: 1px solid;cursor: pointer;border-radius: 0;font-size: 14px;letter-spacing:2px;
  ...
  <input style="background:#f1ab53;border-radius:0; border:none;outline:none;color:#fff;font-size:14px;
...
<div style="display:flex;justify-content:space-around" class="row2">
  <div class="col"><button onclick="ploAnalysisWithDepartmentAverage()" style="width:300px;margin-left:0px;" class="School-wise">PLO Analysis with Department Average</button></div>
  <div class="col"><button onclick="ploAnalysisWithProgramAverage()" style="width:300px;" class="Department-wise">PLO Analysis with Program Average</button></div>
  <div class="col"><button onclick="ploAnalysisWithSchoolAverage()" style="width:300px;" class="Program-wise">PLO Analysis with School Average</button></div>
</div>

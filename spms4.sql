...
(20, 2, 'summer', 'eng105', 2259, 2023),
(22, 1, 'summer', 'eng102', 2259, 2023),
(23, 3, 'summer', 'eng105', 2259, 2023),
(24, 3, 'summer', 'eng105', 2259, 2024),
(25, 3, 'summer', 'eng105', 2259, 2025),
(26, 3, 'summer', 'eng102', 2259, 2022),
(27, 4, 'summer', 'eng102', 2259, 2022),
(28, 4, 'summer', 'eng102', 2259, 2026),
(29, 4, 'summer', 'eng102', 2259, 2027),
(30, 4, 'summer', 'eng102', 2259, 2028),
(31, 4, 'summer', 'eng102', 2259, 2029),
(32, 50, 'summer', 'eng102', 2259, 2029),
(33, 50, 'summer', 'ENG101', 2259, 2022),
(34, 51, 'summer', 'ENG101', 2259, 2022),
(35, 52, 'summer', 'ENG101', 2259, 2022),
(36, 53, 'summer', 'ENG101', 2259, 2022),
(37, 60, 'summer', 'ENG101', 2259, 2022),
(38, 5, 'summer', 'ENG102', 2259, 2028),
(39, 2, 'summer', 'ENG102', 2259, 2022),
(40, 1, 'summer', 'ENG102', 0, 2022);
...
--
-- Table structure for table `student_perf_log_t`
--

CREATE TABLE `student_perf_log_t` (
  `logID` int(11) NOT NULL,
  `time` timestamp NOT NULL DEFAULT current_timestamp(),
  `grade` varchar(5) NOT NULL,
  `scpID` int(11) DEFAULT NULL,
  `f_employeeID` int(11) DEFAULT NULL,
  `registrationID` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `student_perf_log_t`
--

INSERT INTO `student_perf_log_t` (`logID`, `time`, `grade`, `scpID`, `f_employeeID`, `registrationID`) VALUES
(1, '2023-04-26 00:16:35', 'C', 29, 2259, 46),
(2, '2023-04-26 00:23:55', 'C', 41, 2259, 47),
(4, '2023-04-26 00:15:12', 'C', 29, 2259, 46),
(5, '2023-04-26 00:28:36', 'C', 41, 2259, 47),
(6, '2023-04-26 00:32:24', 'C', 41, 2259, 47),
(7, '2023-04-26 00:32:36', 'C', 46, 2259, 48),
(8, '2023-04-26 00:33:32', 'C', 46, 2259, 48),
(9, '2023-04-26 00:38:50', 'G', 48, 2259, 49),
(10, '2023-04-26 00:40:41', 'G', 48, 2259, 49),
(11, '2023-04-26 00:41:37', 'G', 50, 2259, 50),
(12, '2023-04-26 00:44:53', 'G', 50, 2259, 50),
(13, '2023-04-26 00:49:33', 'G', 50, 2259, 50),
(14, '2023-04-26 00:50:34', 'G', 50, 2259, 50),
(15, '2023-04-26 00:51:03', 'G', 50, 2259, 50),
(16, '2023-04-26 00:51:40', 'G', 50, 2259, 50),
(17, '2023-04-26 00:53:51', 'G', 50, 2259, 50),
(18, '2023-04-26 00:54:26', 'G', 50, 2259, 50),
(19, '2023-04-26 00:54:40', 'G', 50, 2259, 50),
(20, '2023-04-26 00:54:53', 'B', 62, 2259, 50),
(21, '2023-04-26 00:55:09', 'B', 62, 2259, 50);
...
--
-- Indexes for table `student_perf_log_t`
--
ALTER TABLE `student_perf_log_t`
  ADD PRIMARY KEY (`logID`),
  ADD KEY `studemt_perf_log_FK1` (`scpID`),
  ADD KEY `studemt_perf_log_FK2` (`f_employeeID`),
  ADD KEY `studemt_perf_log_FK3` (`registrationID`);
...
--
ALTER TABLE `registration_t`
  MODIFY `registrationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `student_course_performance_t`
  MODIFY `scpID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT for table `student_perf_log_t`
--
ALTER TABLE `student_perf_log_t`
...
--
-- Constraints for table `student_perf_log_t`
--
ALTER TABLE `student_perf_log_t`
  ADD CONSTRAINT `studemt_perf_log_FK1` FOREIGN KEY (`scpID`) REFERENCES `student_course_performance_t` (`scpID`),
  ADD CONSTRAINT `studemt_perf_log_FK2` FOREIGN KEY (`f_employeeID`) REFERENCES `faculty_t` (`f_employeeID`),
  ADD CONSTRAINT `studemt_perf_log_FK3` FOREIGN KEY (`registrationID`) REFERENCES `registration_t` (`registrationID`);
COMMIT;
